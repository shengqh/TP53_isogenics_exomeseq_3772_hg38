rm(list=ls()) 
outFile='lindsay_exomeseq_3772'
parSampleFile1=''
parSampleFile2=''
parSampleFile3=''
parFile1='/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip_gatk4_CNV_Germline_07_CombineGCNV/result/lindsay_exomeseq_3772.txt'
parFile2=''
parFile3=''
host="www.ensembl.org";dataset="hsapiens_gene_ensembl";symbolKey="hgnc_symbol";addChr=1

setwd('/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip_gatk4_CNV_Germline_09_CNVGenesLocus/result')
