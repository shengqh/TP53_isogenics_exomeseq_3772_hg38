rm(list=ls()) 
outFile='lindsay_exomeseq_3772.countInFastQcVis.Result'
parSampleFile1=''
parSampleFile2=''
parSampleFile3=''
parFile1='/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/fastqc_raw_summary/result/lindsay_exomeseq_3772.FastQC.reads.tsv'
parFile2='/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/fastqc_post_trim_summary/result/lindsay_exomeseq_3772.FastQC.reads.tsv'
parFile3=''


setwd('/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/fastqc_post_trim_summary/result')
