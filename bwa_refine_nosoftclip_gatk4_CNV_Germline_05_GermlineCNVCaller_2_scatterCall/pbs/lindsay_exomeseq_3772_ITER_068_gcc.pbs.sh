...
gatk --java-options "-Xmx40G" GermlineCNVCaller  \
  --run-mode COHORT \
  -L /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip_gatk4_CNV_Germline_05_GermlineCNVCaller_1_scatterIntervals/result/lindsay_exomeseq_3772.68.interval_list  \
