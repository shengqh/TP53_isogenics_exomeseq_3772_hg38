...
parFile1='/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip_gatk4_CNV_Germline_11_AnnotationGenesPlot/result/lindsay_exomeseq_3772.position.txt.slim'
parFile2=''
parFile3=''
outputDirectory='.'


setwd('/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip_SNV_CNV_Oncoplot/result')
