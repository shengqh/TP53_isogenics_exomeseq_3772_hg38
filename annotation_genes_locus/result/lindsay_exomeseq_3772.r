...
parFile2=''
parFile3=''
host="www.ensembl.org";dataset="hsapiens_gene_ensembl";symbolKey="hgnc_symbol";genesStr="TP53 ATM BARD1 BRCA1 BRCA2 BRIP1 CDH1 CHEK2 MSH6 NBN NF1 PALB2 PTEN RAD51C RAD51D CDKN2A";addChr=1

setwd('/scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/annotation_genes_locus/result')
