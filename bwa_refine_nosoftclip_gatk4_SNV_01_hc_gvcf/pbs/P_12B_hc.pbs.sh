...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_12B.nosoftclip.bam \
  -O P_12B.tmp.g.vcf.gz

if [[ -s P_12B.tmp.g.vcf.gz.tbi ]]; then
  mv P_12B.tmp.g.vcf.gz P_12B.g.vcf.gz
  mv P_12B.tmp.g.vcf.gz.tbi P_12B.g.vcf.gz.tbi
fi
