...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_273_09.nosoftclip.bam \
  -O P_273_09.tmp.g.vcf.gz

if [[ -s P_273_09.tmp.g.vcf.gz.tbi ]]; then
  mv P_273_09.tmp.g.vcf.gz P_273_09.g.vcf.gz
  mv P_273_09.tmp.g.vcf.gz.tbi P_273_09.g.vcf.gz.tbi
fi
