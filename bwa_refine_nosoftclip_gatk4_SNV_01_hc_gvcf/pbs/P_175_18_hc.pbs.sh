...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_175_18.nosoftclip.bam \
  -O P_175_18.tmp.g.vcf.gz

if [[ -s P_175_18.tmp.g.vcf.gz.tbi ]]; then
  mv P_175_18.tmp.g.vcf.gz P_175_18.g.vcf.gz
  mv P_175_18.tmp.g.vcf.gz.tbi P_175_18.g.vcf.gz.tbi
fi
