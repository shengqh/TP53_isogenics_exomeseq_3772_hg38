...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_60B.nosoftclip.bam \
  -O P_60B.tmp.g.vcf.gz

if [[ -s P_60B.tmp.g.vcf.gz.tbi ]]; then
  mv P_60B.tmp.g.vcf.gz P_60B.g.vcf.gz
  mv P_60B.tmp.g.vcf.gz.tbi P_60B.g.vcf.gz.tbi
fi
