...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_42B.nosoftclip.bam \
  -O P_42B.tmp.g.vcf.gz

if [[ -s P_42B.tmp.g.vcf.gz.tbi ]]; then
  mv P_42B.tmp.g.vcf.gz P_42B.g.vcf.gz
  mv P_42B.tmp.g.vcf.gz.tbi P_42B.g.vcf.gz.tbi
fi
