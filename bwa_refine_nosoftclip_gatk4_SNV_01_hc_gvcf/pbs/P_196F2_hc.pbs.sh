...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_196F2.nosoftclip.bam \
  -O P_196F2.tmp.g.vcf.gz

if [[ -s P_196F2.tmp.g.vcf.gz.tbi ]]; then
  mv P_196F2.tmp.g.vcf.gz P_196F2.g.vcf.gz
  mv P_196F2.tmp.g.vcf.gz.tbi P_196F2.g.vcf.gz.tbi
fi
