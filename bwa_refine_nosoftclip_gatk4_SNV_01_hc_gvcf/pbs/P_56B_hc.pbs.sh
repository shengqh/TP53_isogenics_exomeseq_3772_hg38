...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_56B.nosoftclip.bam \
  -O P_56B.tmp.g.vcf.gz

if [[ -s P_56B.tmp.g.vcf.gz.tbi ]]; then
  mv P_56B.tmp.g.vcf.gz P_56B.g.vcf.gz
  mv P_56B.tmp.g.vcf.gz.tbi P_56B.g.vcf.gz.tbi
fi
