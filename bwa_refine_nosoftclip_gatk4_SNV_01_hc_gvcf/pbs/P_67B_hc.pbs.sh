...
gatk --java-options "-Xmx40G" \
  ...
  -I /scratch/cqs/shengq2/jennifer/20200407_lindsay_exomeseq_3772_hg38/bwa_refine_nosoftclip/result/P_67B.nosoftclip.bam \
  -O P_67B.tmp.g.vcf.gz

if [[ -s P_67B.tmp.g.vcf.gz.tbi ]]; then
  mv P_67B.tmp.g.vcf.gz P_67B.g.vcf.gz
  mv P_67B.tmp.g.vcf.gz.tbi P_67B.g.vcf.gz.tbi
fi
